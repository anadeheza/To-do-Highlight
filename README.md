# Tasks Tag Highlighter

I made a VS Code extension with TypeScript to keep track of my comments that usually get lost within my files 

This VS Code extension scans your code for keywords like TODO, FIXME, HACK and more — highlighting them with colors, showing counts in the status bar, and giving you a full workspace summary so nothing slips through the cracks.
...
Feature |	What it does
 ...
 Jump to next	 | Click the status bar to jump through each keyword
 ...
 Problems panel |	Keywords show up as VS Code info diagnostics
...
Show Summary|	Opens the workspace summary panel

Jump to Next |	Jumps to the next keyword in the current file

Search Word |	Highlights a custom word across open files
...
Just type any of these in a comment and they light up  

### Changing Keywords and Colors
...
Search for Todo Highlighter

Click Edit in settings.json under the Keywords section
...
Check or uncheck Comments Only
...
Type Todo Highlighter: Search Word

Enter any word and press Enter
...
Type Todo Highlighter: Show Summary
